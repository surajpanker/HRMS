...
CREATE TABLE `main_empcommunicationdetails` (
  ...
  `emergency_streetaddress` varchar(200) DEFAULT NULL,
  `emergency_country` bigint(20) DEFAULT NULL,
  `emergency_state` bigint(20) DEFAULT NULL,
  `emergency_city` bigint(20) DEFAULT NULL,
  `emergency_pincode` varchar(15) DEFAULT NULL,
