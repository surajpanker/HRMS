    ...
    */	   
	...
	{	
		...
		else if($objName == 'empleavesummary')
		{
            ...
            //$tableFields = array('action'=>'Action','employeename' => 'Leave Applied By','leavetype' => 'Leave Type','leaveday' => 'Leave Duration','from_date' => 'From Date','to_date' => 'To Date','reason' => 'Reason','approver_comments' => 'Comments','reportingmanagername'=>'Superior Name','appliedleavescount' => 'Leave Count','applieddate' => 'Applied On');
