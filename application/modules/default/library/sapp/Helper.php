    ...
    public static function process_emp_excel($file_name)
    {
        ...
        {    		
            ...
            $arrReqHeaders = array(
                ...
                'Grading','Employment Status','Date of joining','Date of leaving','Experience','Extension',
            ...
            try
            {
                ...
                for($i=2; $i <= $sizeOfWorksheet; $i++ )
                {
                    ...
                    {
                        $err_msg = "Grading cannot be empty at row ".$i.".";
                        break;
                    }                    
                    if(empty($rowData[11]))
                    {
                    ...
                    {
                        $err_msg = "Grading is not a valid format at row ".$i.".";
                        break;
                    }
                    ...
                    if(!empty($rowData[9]) && !empty($rowData[10]))
                    {
                        ...
                        {
                            $err_msg = "Grading does not belong to '".$rowData[9]."' job title at row ".$i.".";
                            break;
                        }
                    }
