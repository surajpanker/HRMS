...
class Default_RequisitionController extends Zend_Controller_Action
{
	...
	public function addAction()
	{
		...
		{			
			...
			$norec_arr['reporting_id'] = "Superior Names are not added yet.";
		...
		if(isset($_POST['jobtitle']) && $_POST['jobtitle']!='')
		{
			...
			$form->position_id->addMultiOptions(array(''=>'Select Grading')+$pos_data);
		}
	...
	public function save($requisitionform,$data)
	{
		...
		if($requisitionform->isValid($this->_request->getPost()))
		{
			...
			try
			{
				...
				$req_no_positions = $this->_getParam('req_no_positions',1);
	...
	public function getpositionsAction()
	{
		...
		$options_data = "";
		$options_data .= sapp_Global::selectOptionBuilder('', 'Select Grading');
		if($job_id != '')
		{
