						...
						else
						{
							...
							if(!empty($empdata))
							{
								...
								if(!empty($data))
								{
									...
									{
										$countrieslistArr = $countriesModel->getCountryCode($data[0]['emergency_country']);
										if(sizeof($countrieslistArr)>0)
										{
									...
									{
										$statecurrlistArr = $statesmodel->getStatesList($data[0]['emergency_country']);
										if(sizeof($statecurrlistArr)>0)
										{
											$empcommdetailsform->emergency_state->addMultiOption('','Select State');
											foreach($statecurrlistArr as $statecurrlistres)
											{
												$empcommdetailsform->emergency_state->addMultiOption($statecurrlistres['id'].'!@#'.$statecurrlistres['state_name'],$statecurrlistres['state_name']);
											}
										}
									...
									{
										$cityCurrlistArr = $citiesmodel->getCitiesList($data[0]['emergency_state']);
										...
										if(sizeof($cityCurrlistArr)>0)
										{
											...
											foreach($cityCurrlistArr as $cityCurrlistres)
											{
												$empcommdetailsform->emergency_city->addMultiOption($cityCurrlistres['id'].'!@#'.$cityCurrlistres['city_name'],$cityCurrlistres['city_name']);
											}
										}
