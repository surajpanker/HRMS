...
{ 
	public function init()
	{
        ...
        $course->addValidator('NotEmpty', false, array('messages' => 'Please enter major name.'));
		...
		$course->addValidators(array(
						 array(
							 ...
							 'pattern' =>'/^[a-zA-Z0-9\-\.\s]+$/i',
								 'messages' => array(
										 'regexNotMatch'=>'Please enter valid major name.'
								 )
							 )
						 )
					 )); 
        ...
        $percentage->addValidator('NotEmpty', false, array('messages' => 'Please enter GPA.'));
