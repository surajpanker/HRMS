...
class Default_Form_empjobhistory extends Zend_Form
{
	public function init()
	{
        ...
        $reporting_manager_id = new Zend_Form_Element_Select('reporting_manager_id');
		$reporting_manager_id->setLabel('Superior Name');
		$reporting_manager_id->setRegisterInArrayValidator(false);
		...
		$this->addElements(array($id,$userid,$positionheld,$jobtitleid,$reporting_manager_id,$department,$start_date,$end_date,$received_amount,$paid_amount,$submit));
