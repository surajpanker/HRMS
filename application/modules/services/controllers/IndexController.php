            ...
            )
            {
                ...
                if($role_id == SUPERADMINROLE || $group_id == MANAGEMENT_GROUP || $group_id == HR_GROUP)
                {
                    ...
                    if($privilege_flag == 'Yes')
                    {
                        ...
                        $emp_str = sapp_Global::selectOptionBuilder("", "Select Superior Name");
            ...
            )
            {
                ...
                if($role_id == SUPERADMINROLE || $group_id == MANAGEMENT_GROUP || $group_id == HR_GROUP)
                {
                    ...
                    if($privilege_flag == 'Yes')
                    {
                        ...
                        $positions_str = sapp_Global::selectOptionBuilder("", "Select Grading");
                        ...
                        {
                            $status = 0;
                            $message = "Gradings are not configured yet.";
                        }
                    }
                }
            }
